...
mainDir = 'C:\Users\Kerstin\Desktop\github';
cd(mainDir);
...
Panel.materialEmoText = uicontrol(mainFig,'visible','off','style','text','position',[xStart(3),yStart(1),blockWidth ,blockHeight],'fontsize',14,...
    'backgroundcolor',[0.9 0.9 0.9],...
...
%% Part 4
Panel.materialEmoText = uicontrol(mainFig,'style','text','position',[xStart(1),yStart(2),blockWidth ,blockHeight],'fontsize',14,...
    'backgroundcolor',[0.9 0.9 0.9],...
    'string',{'For new test',...
    ''});
Panel.materialEmoButton = uicontrol(mainFig,'style','pushbutton',...
    'position',[xStart(1)+buttonOffsetX,yStart(2)+buttonOffsetY,buttonWidth,buttonHeight]','fontsize',15,'string','Select');
set(Panel.materialEmoButton,'callback', 'Fcn_QuesVisualTouchMode(mainDir);'); 

%% Part 5
Panel.materialEmoText = uicontrol(mainFig,'style','text','position',[xStart(2),yStart(2),blockWidth ,blockHeight],'fontsize',14,...
    'backgroundcolor',[0.9 0.9 0.9],...
    'string',{'For new test',...
    ''});
Panel.materialEmoButton = uicontrol(mainFig,'style','pushbutton',...
    'position',[xStart(2)+buttonOffsetX,yStart(2)+buttonOffsetY,buttonWidth,buttonHeight]','fontsize',15,'string','Select');
set(Panel.materialEmoButton,'callback', 'Fcn_QuesVisualTouchMode(mainDir);'); 

%% Part 6
Panel.materialEmoText = uicontrol(mainFig,'style','text','position',[xStart(3),yStart(2),blockWidth ,blockHeight],'fontsize',14,...
    'backgroundcolor',[0.9 0.9 0.9],...
    'string',{'For new test',...
    ''});
Panel.materialEmoButton = uicontrol(mainFig,'style','pushbutton',...
    'position',[xStart(3)+buttonOffsetX,yStart(2)+buttonOffsetY,buttonWidth,buttonHeight]','fontsize',15,'string','Select');
set(Panel.materialEmoButton,'callback', 'Fcn_QuesVisualTouchMode(mainDir);'); 
